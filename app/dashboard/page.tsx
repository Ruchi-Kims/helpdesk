          ...
          <table className="w-full min-w-[920px]">
            <thead className="border-b border-gray-100">
              <tr>
                ...
                <th className="text-left text-xs font-medium text-[#8B8FA3] uppercase tracking-wide px-4 py-3">SLA</th>
            ...
            <tbody className="divide-y divide-gray-50">
              {tickets.length === 0 ? (
                <tr>
                  <td colSpan={10} className="text-center text-[#8B8FA3] text-sm py-8">
                    Aucun ticket trouvé
                  </td>
                </tr>
              ) : (
